  ...
  return (
    ...
    >
      <div className="h-full flex flex-col lg:flex-row px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48">
        <div className="h-1/4 md:h-1/3 lg:h-full lg:w-1/2 flex items-center justify-center text-center text-5xl sm:text-6xl">
          <motion.div>
        ...
        >
          ...
          <textarea
            ...
            required
            spellCheck
            className="bg-transparent outline rounded-md outline-gray-400 resize-none p-2 min-h-16"
          />
